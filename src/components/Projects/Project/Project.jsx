    ...
    return (
        <div className="project">
            <div className={`project__data ${position}`} >
                <div className="project__data--name">{name}
                    <div className="project__data--desc-links">
                        <div className="project__data--github">
                            <a target={'_blank'} href={github} className="project__data--link project__data--github-link">
                                <i className="fa-brands fa-github"></i>
                            </a>
                        </div>
                        <div className="project__data--link">
                            <a target={'_blank'} href={href} className="project__data--link project__data--github-link">
                ...
                <div className="project__data--tools">
                    {tools.map((tool, index) => (
                        <img key={index} className='projectTools' src={`./${tool}`} alt="" />
                    ))}
                </div>
            </div>
            <div className="project__img">
