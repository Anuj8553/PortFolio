            ...
            //Experience
                ...
                <div className="experience__content"  >
                    <div className="experience__content--work">
                        <ExperienceWork desc={"I designed and implemented dynamic user interfaces for mobile applications, collaborating with cross-functional teams to integrate backend APIs and optimize database queries for scalability. Additionally, I applied best programming practices to enhance application reliability and performance."} tools={["/android_studio.svg", "/flutter.svg","/git.png","/github.png"]} title={'Software Development Engineer'} link={"https://putoos.com/"} firm={'Putoos.in'} tenure={'July 2024 - September 2024'}></ExperienceWork>
